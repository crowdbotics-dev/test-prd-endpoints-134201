"""
Django settings for test_prd_endpoints_134201 project.
...
ROOT_URLCONF = 'test_prd_endpoints_134201.urls'
...
WSGI_APPLICATION = 'test_prd_endpoints_134201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_endpoints_134201 API",
    "DESCRIPTION": "API documentation for test_prd_endpoints_134201 App",
    "VERSION": "v1",
}
